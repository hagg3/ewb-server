...
//   ./eden_file_test
//
// Every fixture is synthesized by `eden_fixture.h` — no specimen from any
// private tree is copied into this repo. Covers, without a socket or a real
// world file:
...
#include "eden_file.h"
#include "eden_fixture.h"   // synthesized .eden builders, shared with eden_import_test
